...
\chapter{Appréciation du Riichi} \label{ch:riichi}
\thispagestyle{empty}

\section{Déclarer riichi, ou pas?}
Le riichi est un élément très puissant dans le riichi mah-jong. Une fois que vous avez déclaré riichi, les adversaires doivent ralentir leurs attaques ou même se coucher complètement pour éviter de vous donner la victoire. Par conséquent, l'une de nos principales priorités dans le jeu de riichi mah-jong est d'essayer de préparer la main aussi vite que possible et de déclarer riichi avant que quelqu'un d'autre ne le fasse.

\bigskip
En même temps, il y a des situations où vous devez rester {\jap dama} (c'est-à-dire ne pas appeler riichi lorsque vous avez une main fermée en attente). Si vous avez joué au mah-jong assez longtemps, vous avez dû rencontrer de nombreux cas où vous vous êtes demandé si vous deviez déclarer riichi ou rester {\jap dama}. 
Savoir quand déclarer riichi est l'un des éléments les plus fondamental des stratégies de mah-jong, mais il semble que cela ne soit pas très bien compris par les joueurs européens. 
Examinons tout d'abord les avantages et les inconvénients de la déclaration du riichi. 

\bigskip
Les inconvénients évidents de déclarer riichi peuvent être résumés comme suit.
\begin{itembox}[c]{Demerits of riichi}
	\bi \itemsep.1pt
	\i Vous devez payer 1000 points comme pari.
	\i Les adversaires peuvent jouer défensif et ne défausseront pas vos tuiles gagnantes qu'ils auraient autrement défaussées.
	\i Vous ne pouvez plus changer votre main ; vous ne pouvez plus jouer défensif ni améliorer l'attente / la valeur.
	\ei
\end{itembox}
Mais il y a aussi beaucoup d'autres avantages.


\begin{itembox}[c]{Merits of riichi}
	\bi
	\i Vous optenez un {\jap yaku} pour gagner.
	\i Vous pouvez espérer augmenter le score via {\jap ippatsu} et les {\jap ura dora}.
	\i Les adversaires peuvent se coucher complètement ou jouer plus défensivement que d'habitude. Par conséquent, les adversaires peuvent ne pas préparer leur main, auquel cas :
	\bi
	\i vous aurez plus d'occasions de piocher des tuiles; 
	\i vous avez moins de chances de distribuer dans les adversaires.
	\ei
	\i Lorsque vos défausses précédentes donnent l'impression que votre tuile gagnante est sûre, déclarer riichi peut en fait augmenter les chances que l'adversaire vous donne la victoire. 
	\ei
\end{itembox}
...
\bigskip
\noindent
En comparant ces avantages et ces inconvénients, il devrait être évident que déclarer un riichi est une tactique d'attaque à faible risque et à haut rendement. 
De plus, le riichi peut également servir de tactique de défense. Si vous déclarez riichi avant vos adversaires, cela peut les empêcher de construire leur main, ce qui réduit évidemment vos chances de leur donner la victoire. 
Bien que déclarer riichi signifie que vous ne pouvez plus jouer de façon défensive en choisissant des tuiles sûres à défausser, cela pose moins de problèmes si vos compétences défensives ne sont pas très bonnes. 

\bigskip

Les critères de jugement de Riichi que je recommande sont résumés ci-dessous. 

\bigskip
\begin{itembox}[c]{Appréciation du Riichi}
Choisissez riichi plutôt que {\jap dama} si \underline{\large au moins l'une} des trois conditions suivantes est remplie. 
\bi
\i[] 1. Votre main comporte au moins un {\jap han} autre que riichi.
...
\noindent Cela signifie que vous devez déclarer riichi si 
\bi \itemsep.1em
\i votre main a une mauvaise attente mais possède un {\jap han} ou plus (y compris {\jap dora}) autre que riichi;
\i votre main possède seuleument riichi mais avec une bonne attente, ou;
\i votre main possède seuleument riichi avec une mauvaise attente, mais vous êtes le donneur. 
\ei
En d'autres termes, le seul type de riichi que ces critères interdisent est un riichi isolé de mauvaise attente déclaré par un non-donneur. 
